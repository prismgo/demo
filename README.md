...
Catalog 当前覆盖 **29 个模块、476 个条目**：已实现 60 个、计划中 413 个、手工验证 3 个。以下是 README 更新时的快照；`app/demo/catalog/` 是唯一数据源，实时进度以 `demo:list` 输出为准。
...
| `filesystem` | 本地、公共与云文件系统 | 0/67 | 67 | 计划中 |
...
| `translation` | 应用翻译与复数处理 | 0/39 | 39 | 计划中 |
