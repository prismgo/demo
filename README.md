...
Catalog 当前覆盖 **29 个模块、1432 个条目**：已实现 278 个、计划中 1151 个、手工验证 3 个。以下是 README 更新时的快照；`app/demo/catalog/` 是唯一数据源，实时进度以 `demo:list` 输出为准。
...
| `console` | Artisan 风格命令与终端 IO | 20/70 | 50 | 进行中 |
