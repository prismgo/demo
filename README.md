...
Catalog 当前覆盖 **29 个模块、1432 个条目**：已实现 477 个、计划中 952 个、手工验证 3 个。以下是 README 更新时的快照；`app/demo/catalog/` 是唯一数据源，实时进度以 `demo:list` 输出为准。
...
| `exception` | 异常报告与渲染 | 30/77 | 47 | 进行中 |
