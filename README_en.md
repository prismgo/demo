...
The catalog currently covers **29 modules and 87 entries**: 41 implemented, 43 planned, and 3 manually verified. The table below is a snapshot taken when this README was updated. `app/demo/catalog/` is the single source of truth; use `demo:list` for live progress.
...
| `queue` | Queues, jobs, and workers | 40/59 | 19 | In progress |
