...
The catalog currently covers **29 modules and 87 entries**: 39 implemented, 45 planned, and 3 manually verified. The table below is a snapshot taken when this README was updated. `app/demo/catalog/` is the single source of truth; use `demo:list` for live progress.
...
| `queue` | Queues, jobs, and workers | 38/59 | 21 | In progress |
