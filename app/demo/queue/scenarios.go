...
var scenarios = []Scenario{
	...
	{Name: "failure", Section: "Dealing With Failed Jobs", Connections: []string{"redis", "rabbitmq"}},
	{Name: "failed-commands", Section: "Dealing With Failed Jobs", Connections: []string{"redis", "rabbitmq"}},
	{Name: "restart", Section: "Queue Workers and Deployment", Connections: []string{"redis", "rabbitmq"}},
	{Name: "events", Section: "Lifecycle Events", Connections: []string{"sync", "redis", "rabbitmq"}},
