...
var scenarios = []Scenario{
	...
	{Name: "strategy-envelope", Section: "Job Strategy Interfaces", Status: "implemented", Connections: []string{"sync"}},
	{Name: "unique", Section: "Unique Jobs", Status: "implemented", Connections: []string{"sync", "redis"}, Requires: []string{"redis"}},
	{Name: "unique-options", Section: "Unique Jobs", Status: "implemented", Connections: []string{"sync"}},
	{Name: "debounce", Section: "Debounced Jobs", Status: "implemented", Connections: []string{"redis", "rabbitmq"}, Requires: []string{"redis", "rabbitmq"}},
	{Name: "debounce-options", Section: "Debounced Jobs", Status: "implemented", Connections: []string{"redis", "rabbitmq"}, Requires: []string{"redis", "rabbitmq"}},
	{Name: "middleware", Section: "Job Middleware", Status: "implemented", Connections: []string{"sync"}},
	{Name: "overlap-release", Section: "Preventing Job Overlaps", Status: "implemented", Connections: []string{"sync"}},
	...
	{Name: "job-control", Section: "Error Handling", Status: "implemented", Connections: []string{"redis", "rabbitmq"}, Requires: []string{"redis", "rabbitmq"}},
	...
	{Name: "worker-command", Section: "The queue:work Command", Status: "implemented", Connections: []string{"redis", "rabbitmq"}, Requires: []string{"redis", "rabbitmq"}},
	{Name: "expiration", Section: "Job Expirations and Timeouts", Status: "implemented", Connections: []string{"redis", "rabbitmq"}, Requires: []string{"redis", "rabbitmq"}},
	...
	{Name: "failed-command-paths", Section: "Cleaning Up After Failed Jobs", Status: "implemented", Connections: []string{"sync"}},
	{Name: "failed-retry", Section: "Retrying Failed Jobs", Status: "implemented", Connections: []string{"redis", "rabbitmq"}, Requires: []string{"redis", "rabbitmq"}},
