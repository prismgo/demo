...
var Entries = []Entry{
	...
	baselineEntry("queue", "Driver prerequisites", "驱动注意事项与前提条件", "Driver Prerequisites", "demo:queue driver-prerequisites", "driver-prerequisites", "TestQueueDemoDriverPrerequisites", LevelIntegration, StatusPlanned, "redis", "rabbitmq"),
	baselineEntry("queue", "Configuration loading", "配置文件", "Config File", "demo:queue config", "config", "TestQueueDemoConfiguration", LevelHermetic, StatusPlanned),
	baselineEntry("queue", "Payload encoding configuration", "顶层配置", "Global", "demo:queue payload-encoding", "payload-encoding", "TestQueueDemoPayloadEncoding", LevelHermetic, StatusPlanned),
	baselineEntry("queue", "Sync connection configuration", "Sync 连接", "Sync Connection", "demo:queue sync-connection", "sync-connection", "TestQueueDemoSyncConnectionConfiguration", LevelHermetic, StatusPlanned),
	baselineEntry("queue", "Failed store configuration", "失败任务存储", "Failed Jobs Store", "demo:queue failed-store", "failed-store", "TestQueueDemoFailedStoreConfiguration", LevelIntegration, StatusPlanned, "redis"),
	baselineEntry("queue", "Batch store configuration", "批次状态存储", "Batching Store", "demo:queue batch-store", "batch-store", "TestQueueDemoBatchStoreConfiguration", LevelIntegration, StatusPlanned, "redis"),
	baselineEntry("queue", "Restart store configuration", "重启信号存储", "Restart Store", "demo:queue restart-store", "restart-store", "TestQueueDemoRestartStoreConfiguration", LevelIntegration, StatusPlanned, "redis"),
	...
	baselineEntry("queue", "Strategy envelope and option precedence", "任务策略接口", "Job Strategy Interfaces", "demo:queue strategy-envelope", "strategy-envelope", "TestQueueDemoStrategyEnvelope", LevelHermetic, StatusPlanned),
	...
	baselineEntry("queue", "Unique dispatch options", "唯一任务", "Unique Jobs", "demo:queue unique-options", "unique-options", "TestQueueDemoUniqueDispatchOptions", LevelHermetic, StatusPlanned),
	...
	baselineEntry("queue", "Debounce dispatch options", "防抖任务", "Debounced Jobs", "demo:queue debounce-options --connection=redis", "debounce-options", "TestQueueDemoDebounceDispatchOptions", LevelIntegration, StatusPlanned, "redis", "rabbitmq"),
	...
	baselineEntry("queue", "Overlap release policy", "防止任务重叠", "Preventing Job Overlaps", "demo:queue overlap-release", "overlap-release", "TestQueueDemoOverlapReleasePolicy", LevelHermetic, StatusPlanned),
	...
	baselineEntry("queue", "Job control errors", "错误处理", "Error Handling", "demo:queue job-control --connection=redis", "job-control", "TestQueueDemoJobControlErrors", LevelIntegration, StatusPlanned, "redis", "rabbitmq"),
	...
	baselineEntry("queue", "Queue worker command", "queue:work 命令", "The queue:work Command", "demo:queue worker-command --connection=redis", "worker-command", "TestQueueDemoWorkerCommand", LevelIntegration, StatusPlanned, "redis", "rabbitmq"),
	baselineEntry("queue", "Job expiration and timeout policies", "任务过期与超时", "Job Expirations and Timeouts", "demo:queue expiration --connection=redis", "expiration", "TestQueueDemoExpirationPolicies", LevelIntegration, StatusPlanned, "redis", "rabbitmq"),
	...
	baselineEntry("queue", "Failed cleanup command paths", "清理失败任务", "Cleaning Up After Failed Jobs", "demo:queue failed-command-paths", "failed-command-paths", "TestQueueDemoFailedCleanupCommandPaths", LevelScenario, StatusPlanned),
	baselineEntry("queue", "Failed job retry command", "重试失败任务", "Retrying Failed Jobs", "demo:queue failed-retry --connection=redis", "failed-retry", "TestQueueDemoFailedRetryCommand", LevelIntegration, StatusPlanned, "redis", "rabbitmq"),
	...
	baselineEntry("queue", "Failed job lifecycle event", "生命周期事件", "Lifecycle Events", "demo:queue failed-event --connection=redis", "failed-event", "TestQueueDemoFailedEvent", LevelIntegration, StatusPlanned, "redis", "rabbitmq"),
	baselineEntry("queue", "Batch lifecycle events", "生命周期事件", "Lifecycle Events", "demo:queue batch-events --connection=redis", "batch-events", "TestQueueDemoBatchEvents", LevelIntegration, StatusPlanned, "redis", "rabbitmq"),
