...
func (c *QueueCommand) Definition() *console.Definition {
	...
	definition.Examples = []string{
		...
		"go run ./demo demo:queue debounce-options --connection=redis",
		"go run ./demo demo:queue overlap-release",
		"go run ./demo demo:queue job-control --connection=redis",
		"go run ./demo demo:queue worker-command --connection=redis",
		"go run ./demo demo:queue expiration --connection=redis",
		"go run ./demo demo:queue failed-commands",
		"go run ./demo demo:queue failed-command-paths",
		"go run ./demo demo:queue failed-retry --connection=redis",
